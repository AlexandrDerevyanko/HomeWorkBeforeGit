...
var bavarianModel: [String] = []

func addBavarianModel (model: String) {
    bavarianModel.append (model)
}
 
func deleteBavarianModel (modelNumber: String) {
    if  bavarianModel.firstIndex(of: modelNumber) != nil {
        bavarianModel.remove(at:bavarianModel.firstIndex(of: modelNumber)!)
    } else if bavarianModel.isEmpty {
        print("Массив пустой")
    } else {
...
addBavarianModel(model: "M5")
addBavarianModel(model: "6")
addBavarianModel(model: "7")
addBavarianModel(model: "M8")

deleteBavarianModel(modelNumber: "7")
deleteBavarianModel(modelNumber: "7")
print(bavarianModel)
...
userPoints
 ...
 func pointsExchange (file: [Int: Double]) -> [Int: Int] {
     var userMoney: [Int: Int] = [:]
     for (key, value) in file {
         userMoney[key] = Int(value) / 10
     }
     return userMoney
 }
 print(pointsExchange(file: userPoints))
